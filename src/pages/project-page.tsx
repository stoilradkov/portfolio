      ...
      <SectionShell className="pt-4">
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            {
              label: 'Stack',
              value: `${project.stack.slice(0, 4).join(', ')} + more`,
            },
          ].map((item, index) => (
      ...
      <SectionShell className="pb-12">
        <FadeIn className="color-wash space-y-5 rounded-4xl px-5 py-7 sm:px-7 sm:py-8">
          ...
          <p className="max-w-2xl text-base leading-7 text-muted-foreground">
            I work best with teams building useful software for real operations.
            If that sounds like your project, feel free to reach out.
          </p>
